            ...
            {!isOnline && (
                <div className="fixed top-0 left-0 right-0 z-50 bg-amber-500 text-white px-4 py-2 shadow-lg">
                    <div className="flex items-center justify-center gap-3">
                        ...
                        <button
                            onClick={handleRetry}
                            className="flex items-center gap-1 rounded-lg bg-white/20 px-3 py-1 text-xs font-medium hover:bg-white/30 transition-colors"
                        >
            ...
            {user && showSidebar ? (
                <div className="flex h-screen overflow-hidden">
                    ...
                    <div className="flex flex-1 flex-col overflow-hidden">
                        ...
                        />
                        <main className={`flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 ${!isOnline ? 'pt-14' : ''}`}>
