...
export function SupportChatButton({ className }: SupportChatButtonProps) {
    ...
    return (
        <>
            {/* Floating button - GREEN as requested */}
            <button
                onClick={handleOpen}
                className={`fixed bottom-6 right-6 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-green-500 text-white shadow-lg transition-all hover:bg-green-600 hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 ${className}`}
